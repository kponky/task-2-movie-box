    ...
    <div className="jumbotron" style={{backgroundImage: `url(${`https://image.tmdb.org/t/p/original${poster_path}`})`}}>
     ...
     <div className='root-footer'>
        <div className='socials'>
          <a href='https://web.facebook.com/ikponkeabasi.essia/' target='_blank' rel="noreferrer"> 
           <i className="fa fa-facebook"></i>
          </a>

          <a href='https://www.instagram.com/esyteena/' target='_blank' rel="noreferrer">
           <i className="fa fa-instagram footer-icon"></i> 
          </a>

          <a href='https://twitter.com/AbasiEssia' target='_blank' rel="noreferrer"> 
        ...
        <p>© 2023 MovieBox Replica by Abtech  </p>
     </div>
    </>
  )
}